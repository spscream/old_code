...
function accmGetCalls($date=0,$format=null,$count=0,$agent=0,$callerid=0)
{
	...
	$query=$query."and q1.reason in (7,8,16) ".
...
function accmGet($item,$date=0,$format=null,$count=0,$callid=0)
{
	global $dbh;
	$query='';
	switch ($item) {
...
function accmGetAgentsStat($date=0,$format=null,$count=0)
{
